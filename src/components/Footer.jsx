  ...
  return (
    <div className="ml-0 ">
      <footer className="footer   p-10  text-white bg-black" >
        <nav>
          <h6 className="footer-title text-gray-50 text-2xl">Services</h6>
        ...
        <nav>
          <h6 className="footer-title text-gray-50 text-2xl">Company</h6>
        ...
        <nav>
          <h6 className="footer-title text-2xl text-gray-50">Legal</h6>
